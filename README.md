<h1 align="center">Hey there, I'm Marouan 👋</h1>

<p align="center">
  🎓 Software Engineering student @ ENSAH Al Hoceima 🇲🇦<br>
  💻 Full-Stack Developer in the making — focused on Java Backend ☕<br>
  ☁️ Passionate about AI & Cloud Computing<br>
  🚀 Currently leveling up with React via Full Stack Open
</p>
...
- ⚛️ **React** — via Full Stack Open (University of Helsinki)
- ☕ **Java Backend** — building toward Spring Boot
- ☁️ **Cloud Computing & AI** — exploring fundamentals
- 🐧 **Linux Server Administration** (vsftpd, FTPS, virtual users)
